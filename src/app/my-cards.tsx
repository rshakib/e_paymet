  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.featureTitle}>My Cards</Text>
        <Text style={styles.featureSub}>
          Link, manage, and view statements for your debit and credit cards directly within NiroPay. This feature is coming soon.
        </Text>
