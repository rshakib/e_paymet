...
export default function RechargeSuccessScreen() {
  ...
  // Parse parameters with fallbacks matching Screen 4 requirements
  ...
  const txId = 'NPRRC' + Math.floor(100000000 + Math.random() * 900000000);
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <Text style={styles.sub}>Your mobile recharge has been processed</Text>
        ...
        <View style={styles.receiptCard}>
          ...
          <View style={styles.receiptRow}>
            <Text style={styles.rowLabel}>Recharge Type</Text>
            <Text style={styles.rowValue}>{rechargeType}</Text>
          </View>
