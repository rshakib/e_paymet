  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.featureTitle}>Savings Scheme</Text>
        <Text style={styles.featureSub}>
          Open high-interest savings plans and track your financial growth inside the NiroPay ecosystem. This feature is coming soon.
        </Text>
