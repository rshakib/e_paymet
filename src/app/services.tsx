  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.featureTitle}>Services Catalog</Text>
        <Text style={styles.featureSub}>
          Access our full directory of integrated micro-services, ticketing, shopping, and transfers inside NiroPay. This list is coming soon.
        </Text>
