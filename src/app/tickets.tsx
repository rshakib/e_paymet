  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.featureTitle}>Purchase Tickets</Text>
        <Text style={styles.featureSub}>
          Buy movie, bus, train, or event tickets instantly and pay securely with your NiroPay account balance. This feature is coming soon.
        </Text>
